...
Furthermore, NGC 3201 contains segregated stellar mass black holes in binary systems (systems with two stars) and likely has no large black holes at the centre of the cluster. Research shows that there are roughly 100 segregated stellar mass black holes (similar mass to the Sun), and it is likely that do not lie in the centre, due to research done on binary systems in the centre of globular clusters. This suggests NGC 3201 did contain massive hot stars in the past, as massive stars are necessary for a core collapse. Moreover, NGC3201...
